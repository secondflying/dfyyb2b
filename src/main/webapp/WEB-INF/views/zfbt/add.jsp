...
<c:set var="pageTitle" value="新增秒杀" scope="request" />
	...
	<form id="second" action="${addUrl}" method="post">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="title" name='title' id="title" class="input-xxlarge" placeholder="输入配方标题" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea rows="5" path="content" name='content' id="content" class="span8" placeholder="输入描述信息"></textarea>
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input path="oprice" name='oprice' id="oprice" class="input-xxlarge" placeholder="输入原价" onkeyup="clearNoNum(this)"
						maxlength="10" />
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input path="nprice" name='nprice' id="nprice" class="input-xxlarge" placeholder="输入现价" onkeyup="clearNoNum(this)"
						maxlength="10" />
					<span class="help-inline"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="count" name='count' id="count" class="input-xxlarge" placeholder="" style="IME-MODE: disabled;"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="maxbuy" name='maxbuy' id="maxbuy" class="input-xxlarge" placeholder="" value="1" style="IME-MODE: disabled;"
						onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"
						maxlength="5" />
					<span class="help-inline"></span>
				</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="coupon" name='coupon' id="coupon" class="input-xxlarge" placeholder="" value="0"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="couponMax" name='couponMax' id="couponMax" class="input-xxlarge" placeholder="" value="0"
						style="IME-MODE: disabled;" onkeyup="this.value=this.value.replace(/\D/g,'')"
						onafterpaste="this.value=this.value.replace(/\D/g,'')" maxlength="5" />
					<span class="help-inline"></span>
				</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					辐射范围（米）：<input id="size" path="size" name='size' placeholder="输入辐射范围（米）" style="IME-MODE: disabled;"
						onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" /><span class="help-inline"></span>
