...
<c:set var="pageTitle" value="农资店订单" scope="request" />
				...
				<c:forEach items="${orders}" var="ord">
					<tr>
						...
						<td><c:choose>
							...
							<td>
								<c:url var="infoUrl" value="storeorder?id=${ord.id}" /> 
		 ...
		 var size = 20;
		    ...
		    var options = {
		            ...
		            onPageClicked: function (event, originalEvent, type, page) { 
		            	var page = page-1; 
		        		window.location.href = '<c:url value="storeorders" />?page=' + page + "&size=" + size;
		            }
		    };
