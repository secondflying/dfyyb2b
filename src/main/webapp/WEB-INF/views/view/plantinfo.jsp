	...
	<div class="container">
		<div class="mblock">
			<div class="muser">
				...
				<div class="muserlevel muserlevel${question.writer.levelID }">${question.writer.identifier}${vu:getLevelName(question.writer.levelID) }</div>
				<div class="mtime">${vu:getStandardDate(question.time) }</div>
				<div class="mcrop">${question.crop.name}</div>
				<div class="mcrop2">${question.cate.name}</div>
			</div>
