...
<c:set var="pageTitle" value="增加商品单位" scope="request" />
...
<section class="well">
	<c:url var="perfectUrl" value="/manager/parameters/addunit" />
	<form id="crop" action="${perfectUrl}" method="post" enctype="multipart/form-data">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="name" name='name' id="name" class="input-xxlarge" placeholder="输入名称" required />
