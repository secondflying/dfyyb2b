...
<c:set var="pageTitle" value="增加商品分类" scope="request" />
...
<section class="well">
	<c:url var="perfectUrl" value="/manager/parameters/addcrop" />
	<form id="crop" action="${perfectUrl}" method="post" enctype="multipart/form-data">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="cname" name='cname' id="cname" class="input-xxlarge" placeholder="父类名称"/>
