...
<c:set var="pageTitle" value="赶大集" scope="request" />
								...
								<div class="row">
									...
									<div style="display: inline-block;">
										...
										<div style="text-align: left;">
											...
											<label style="font-size: 10px; display: inline-block;">时间：<fmt:formatDate value='${response.time}' type='date' pattern='yyyy-MM-dd HH:mm:ss' /></label>
											&nbsp;&nbsp;
