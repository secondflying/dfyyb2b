	...
	<form id="userform" action="${perfectUrl}" method="post">
		<fieldset>
			...
			<div class="control-group">
				...
				<select class="span5" name="type.id" id="typeid">
					<c:forEach items="${types}" var="type">
						<c:choose>
						   <c:when test="${user.type.id==type.id }">   
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="contacts" name='contacts' id="contacts" class="input-xxlarge" placeholder="联系人姓名" required value="${user.contacts }"/>
					<span class="help-inline"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					经度：<input id="x" path="x" name='x' placeholder="输入经度" value="${user.x }"/>
					纬度：<input id="y" path="y" name='y' placeholder="输入纬度" value="${user.y }"/>
					<span class="help-inline"></span>
