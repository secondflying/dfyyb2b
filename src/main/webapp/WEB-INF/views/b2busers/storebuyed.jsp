					...
					<tr>
						...
						<td>
							<c:if test="${commodity.status==3 }">
								<c:url var="infoUrl" value="storecommodity?id=${commodity.id}" /> 
								<a id="infoa"	class="btn btn-small btn-info" href="${infoUrl}"> 查看 </a>
							</c:if>
						</td>
					</tr>
				</c:forEach>
		 ...
		 var size = 20;
		    ...
		    var options = {
		            ...
		            onPageClicked: function (event, originalEvent, type, page) { 
		            	var page = page-1; 
		        		window.location.href = '<c:url value="storebuyed" />?page=' + page + "&size=" + size;
		            }
		    };
