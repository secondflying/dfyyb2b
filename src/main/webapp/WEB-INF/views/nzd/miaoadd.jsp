...
<section class="well shadow">
	<c:url var="addUrl" value="/nzd/miao/add" />	
	<form id="second" action="${addUrl}" method="post">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="oprice" name='oprice' id="oprice" class="input-xxlarge" placeholder="输入原价" onkeyup="clearNoNum(this)" maxlength="10"/>
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input path="nprice" name='nprice' id="nprice" class="input-xxlarge" placeholder="输入现价" onkeyup="clearNoNum(this)" maxlength="10"/>
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input path="starttime" name='starttime' id="starttime" class="input-xxlarge" data-date-format="yyyy-mm-dd hh:ii" class="form_datetime" />
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input path="endtime" name='endtime' id="endtime" class="input-xxlarge" data-date-format="yyyy-mm-dd hh:ii" class="form_datetime" placeholder="" />
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input path="count" name='count' id="count" class="input-xxlarge" placeholder="" 
