...
<c:set var="pageTitle" value="新增配方" scope="request" />
<jsp:include page="header.jsp" />


<section class="well shadow">
	<c:url var="addUrl" value="/nzd/index/add" />	
	<form id="reicpe" action="${addUrl}" method="post">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="price" name='price' id="price" class="input-xxlarge" placeholder="输入原价" onkeyup="clearNoNum(this)" maxlength="10" />
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input path="newprice" name='newprice' id="newprice" class="input-xxlarge" placeholder="输入现价" onkeyup="clearNoNum(this)" maxlength="10" />
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					...
					<c:forEach items="${diseases}" var="disease">
						<option value="${disease.id}"><c:out value="${disease.name}" /></option>
					</c:forEach>
					</select>
					<span class="help-inline"></span>
				</div>
