	...
	<form id="second" action="${addUrl}" method="post">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="maxbuy" name='maxbuy' id="maxbuy" class="input-xxlarge" placeholder=""  value="${second.maxbuy}" style="IME-MODE: disabled;"
			...
			<div class="control-group">
				...
				<div class="controls">
					经度：<input id="x" path="x" name='x' value="${second.x}" placeholder="输入经度" />
					纬度：<input id="y" path="y" name='y' value="${second.y}" placeholder="输入纬度" />
					辐射范围（米）：<input id="size" path="size" name='size' value="${second.size}" placeholder="输入辐射范围（米）" style="IME-MODE: disabled;"
