	...
	<form id="commodity2" action="${addUrl}" method="post">
		<fieldset>
			...
			<div class="control-group">
				...
				<input type="hidden" path="id" name='id' id="id" class="input-xxlarge" value="${guagua.id}" />
				<div class="controls">
					<input path="name" name='name' id="name" class="input-xxlarge" placeholder="输入商品名称" value="${guagua.name}" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="count" name='count' id="count" class="input-xxlarge" placeholder="输入个数" value="${guagua.count}" onkeyup="clearNoNum(this)"
						maxlength="20" />
					<span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input path="lucky" name='lucky' id="lucky" class="input-xxlarge" placeholder="输入中奖概率" value="${guagua.lucky}" onkeyup="clearNoNum(this)"
						maxlength="20" />
					<span class="help-inline"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="starttime" name='starttime' id="starttime" class="input-xxlarge" value="<fmt:formatDate value='${guagua.starttime}' type='date' pattern='yyyy-MM-dd HH:mm'/>" data-date-format="yyyy-mm-dd hh:ii"
						class="form_datetime" />
					<span class="help-inline"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input path="endtime" name='endtime' id="endtime" class="input-xxlarge" value="<fmt:formatDate value='${guagua.endtime}' type='date' pattern='yyyy-MM-dd HH:mm'/>" data-date-format="yyyy-mm-dd hh:ii"
						class="form_datetime" />
					<span class="help-inline"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<textarea rows="5" path="description" name='description' id="description" class="span8" placeholder="输入描述信息">${guagua.description}</textarea>
					<span class="help-inline"></span>
				</div>
			</div>
			...
			<div id="attachmentsdiv">
				<div id="panel1"
					...
					<img class="image" src="${imageUrl}/${guagua.image}" />
					<a class="imageClose" href="javascript:deleteImagePanel(1)"></a>
					<input type="hidden" path="image" name="image" id="image" value="${guagua.image}" />
				</div>
			</div>
